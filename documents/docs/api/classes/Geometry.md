...
• **new Geometry**(`renderer`, `attributes?`): [`Geometry`](Geometry.md)
...
[src/core/Geometry.ts:65](https://github.com/sakitam-gis/vis-engine/blob/master/src/core/Geometry.ts#L65)
