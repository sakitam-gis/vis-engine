...
• **new PerspectiveCamera**(`fov`, `aspect`, `near`, `far`): [`PerspectiveCamera`](PerspectiveCamera.md)
...
[src/cameras/PerspectiveCamera.ts:13](https://github.com/sakitam-gis/vis-engine/blob/master/src/cameras/PerspectiveCamera.ts#L13)
...
[src/cameras/PerspectiveCamera.ts:25](https://github.com/sakitam-gis/vis-engine/blob/master/src/cameras/PerspectiveCamera.ts#L25)
