...
const features = [
  {
    ...
    description: (
      <>
        I'm not sure whether it is easy to use. It comes from three.js. There are many similar designs, but it is more concise.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        Easy to expand, I will try my best to ensure its scalability.
      </>
    ),
  },
];
